        ...
        <div class="white-box">
            ...
            <form class="form-horizontal new-lg-form" role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group{{ $errors->has('security_question') ? ' has-error' : '' }}">
                    <div class="col-xs-12">
                        <select  class="form-control" name="security_question">
                            <option value="" readonly> Select your security question </option>
                ...
                <div class="form-group{{ $errors->has('security_answer') ? ' has-error' : '' }}">
                    <div class="col-xs-12">
                        <input id="password-confirm" placeholder="Your answer" type="text" class="form-control" name="security_answer" required>

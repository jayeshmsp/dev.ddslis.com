<div class='box-body'>
    ...
    <div class='row'>
        ...
        <div class="form-group">
            <label class="control-label col-lg-3" for="question">Security Question</label>
            <div class="col-lg-6">
                <ul class="question-div">
            ...
            <div class="col-lg-2">
                <a href="javascript:void(0)" class="btn btn-warning btn-sm add-security-question-btn" ><span class="glyphicon glyphicon-plus"></span></a>
            </div>
        </div>
    </div>
</div>